...
- Resolves generic merchant language such as `salon` against current offer-linked merchants only when the exact merchant changes the decision; it never silently applies a brand-specific offer.
